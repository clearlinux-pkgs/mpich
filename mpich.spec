...
export CFLAGS="$CFLAGS -fno-semantic-interposition -O3 -flto -ffunction-sections "
export CXXFLAGS="$CXXFLAGS -fno-semantic-interposition -O3 -flto -ffunction-sections "
